...
import { type AlertIncidentSwitchHandle } from './AlertsIncidents/AlertIncidentTabs';
  ...
  return (
    <ButtonGroup className={styles.group}>
      <Button
        ...
        icon="bell"
        onClick={() => alertIncidentRef.current?.switch('firing-alerts', true)}
      >
      ...
      <Button
        ...
        icon="fire"
        onClick={() => alertIncidentRef.current?.switch('incidents', true)}
      >
        <Stack direction="row" alignItems="center" gap={1}>
          <Text>{50}+</Text>
        </Stack>
